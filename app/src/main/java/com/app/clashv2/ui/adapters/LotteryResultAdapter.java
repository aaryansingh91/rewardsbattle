...
import com.app.clashv2.ui.activities.SelectedLotteryActivity;
...
public class LotteryResultAdapter extends RecyclerView.Adapter<LotteryResultAdapter.MyViewHolder> {
    ...
    @Override
    public LotteryResultAdapter.MyViewHolder onCreateViewHolder( ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder( final LotteryResultAdapter.MyViewHolder holder, int position) {
        ...
        holder.lotteryresultcv.setOnClickListener(view -> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder( View itemView) {
            ...
            lotteryresultcv= itemView.findViewById(R.id.lotteryresultcardview);
            limageview= itemView.findViewById(R.id.lrimageview);
            winprize = itemView.findViewById(R.id.lrwonprize);
            title = itemView.findViewById(R.id.lrtitle);
            time = itemView.findViewById(R.id.lrtime);
            wonby = itemView.findViewById(R.id.lrwonby);
        }
    }
}
