...
import com.app.rewardsbattle.models.JoinSingleMatchData;
import com.app.rewardsbattle.ui.adapters.SelectMatchPositionAdapter;
...
public class SelectMatchPositionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        teamAbcd = findViewById(R.id.teamabcd);
        team1234 = findViewById(R.id.team1234);
        ...
        rv = findViewById(R.id.positionrv);
        join = findViewById(R.id.joinfinal);
        back = findViewById(R.id.backfromselectposition);
        matchTitleBar = findViewById(R.id.matchtitlebarinposition);
        ...
        if (TextUtils.equals(type, "Solo")) {
            ...
            double d = Double.parseDouble(no_of_position) / 4;
                ...
                response -> {
                    ...
                    try {
                        if (response.getString("status").equals("false")) {
                            ...
                            JSON_PARSE_DATA_AFTER_WEBCALL(no_of_position, resarr, matchobj.getString("m_id"), matchobj.getString("entry_fee"), matchname, type, msgobj.getString("pubg_id"));
                        }
                    }
    ...
    public void JSON_PARSE_DATA_AFTER_WEBCALL(String noOfposition, final JSONArray array, final String matchid, final String entryfee, final String mname, final String type, final String playername) {
        ...
        for (int i = 0; i < array.length(); i++) {
            try {
                ...
                mData.add(data);
                myAdapter = new SelectMatchPositionAdapter(SelectMatchPositionActivity.this, mData,type, Integer.parseInt(noOfposition));
        ...
        join.setOnClickListener(view -> {
            if (myAdapter.checkBoxList.isEmpty()) {
                ...
                if (TextUtils.equals(type, "Solo")) {
                    if (myAdapter.checkBoxList.size() != 1) {
                        ...
                        dialog.setPositiveButton(resources.getString(R.string.ok), (dialog14, which) -> dialog14.dismiss()).create().show();
                    ...
                    if (myAdapter.checkBoxList.size() > 2) {
                        ...
                        dialog.setPositiveButton(resources.getString(R.string.ok), (dialog13, which) -> dialog13.dismiss()).create().show();
                        //Toast.makeText(SelectMatchPositionActivity.this, "You can select only 1 Spot in Free Match.", Toast.LENGTH_SHORT).show();
                    } else {
                        Intent intent = new Intent(getApplicationContext(), JoiningMatch.class);
                        intent.putExtra("MATCH_NAME", mname);
                    ...
                    if (myAdapter.checkBoxList.size() > 4) {
                        ...
                        dialog.setPositiveButton(resources.getString(R.string.ok), (dialog12, which) -> dialog12.dismiss()).create().show();
                        //Toast.makeText(SelectMatchPositionActivity.this, "You can select only 1 Spot in Free Match.", Toast.LENGTH_SHORT).show();
                    } else {
                        Intent intent = new Intent(getApplicationContext(), JoiningMatch.class);
                        intent.putExtra("MATCH_NAME", mname);
                    ...
                    if (myAdapter.checkBoxList.size() > 5) {
                        ...
                        dialog.setPositiveButton(resources.getString(R.string.ok), (dialog1, which) -> dialog1.dismiss()).create().show();
                        //Toast.makeText(SelectMatchPositionActivity.this, "You can select only 1 Spot in Free Match.", Toast.LENGTH_SHORT).show();
                    } else {
                        Intent intent = new Intent(getApplicationContext(), JoiningMatch.class);
                        intent.putExtra("MATCH_NAME", mname);
