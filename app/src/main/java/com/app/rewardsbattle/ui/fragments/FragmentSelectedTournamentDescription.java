...
import com.app.rewardsbattle.utils.URLImageParser;
...
public class FragmentSelectedTournamentDescription extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        pullToRefresh = root.findViewById(R.id.pullToRefreshselecttournament);
        ...
        room_password_title = root.findViewById(R.id.room_password_title_id);
        room_id_titile = root.findViewById(R.id.room_id_titile_id);
        teamtitle = root.findViewById(R.id.teamtitleid);
        entryfeetitle = root.findViewById(R.id.entryfeetitleid);
        modetitle = root.findViewById(R.id.modetitleid);
        matchtypetitle = root.findViewById(R.id.matchtypetitleid);
        maptitle = root.findViewById(R.id.maptitleid);
        matchscheduletitle = root.findViewById(R.id.matchscheduletitleid);
        winnigprizetitle = root.findViewById(R.id.winningprizetitleid);
        perkilltitle = root.findViewById(R.id.perkilltitleid);
        pricedetails = root.findViewById(R.id.pricedetaititleid);
        aboutmatchtitle = root.findViewById(R.id.aboutmatchtitleid);
        matchprivateDesctitle = root.findViewById(R.id.matchprivateDesctitleid);
        roomdetailltitle = root.findViewById(R.id.roomdetailltitleid);
        matchprivateDescription = root.findViewById(R.id.matchprivateDescid);
        roomidcard = root.findViewById(R.id.roomidcard);
        ...
        matchTitleAndNumber = root.findViewById(R.id.matchtitleandnumber);
        team = root.findViewById(R.id.team);
        entryFee = root.findViewById(R.id.entryfee);
        mode = root.findViewById(R.id.mode);
        matchType = root.findViewById(R.id.matchtype);
        map = root.findViewById(R.id.map);
        matchSchedule = root.findViewById(R.id.matchschedule);
        winningPrize = root.findViewById(R.id.winningprize);
        perKill = root.findViewById(R.id.perkill);
        about = root.findViewById(R.id.about);
        sponser = root.findViewById(R.id.sponsor);
        rData = root.findViewById(R.id.registereddata);
        roomDetail = root.findViewById(R.id.roomdetailll);
        matchpraivDescdetaill = root.findViewById(R.id.matchpraivDescdetaillid);
        roomId = root.findViewById(R.id.roomid);

        roomPass = root.findViewById(R.id.roompass);
        playNow = root.findViewById(R.id.playnow);
        joinedll = root.findViewById(R.id.joinedll);
        sponsorll = root.findViewById(R.id.sponsorll);
                ...
                response -> {
                    ...
                    try {
                        ...
                        if (TextUtils.equals(matchprivateDesc, "") || !TextUtils.equals(join_status, "true")) {
                            ...
                            matchprivateDescription.setClickable(true);
                            matchprivateDescription.setMovementMethod(LinkMovementMethod.getInstance());
                        ...
                        if (TextUtils.equals(roomIds, "") || TextUtils.equals(roomPassword, "") || !TextUtils.equals(join_status, "true")) {
                            ...
                            if (TextUtils.equals(roomIds, null) || TextUtils.equals(roomIds, "null") || roomIds.isEmpty()) {
                                ...
                                roomId.setClickable(true);
                                roomId.setMovementMethod(LinkMovementMethod.getInstance());
                            }
                            ...
                            roomId.setOnClickListener(view -> {
                            ...
                            roomPass.setOnClickListener(view -> {
                                ClipboardManager clipboard = (ClipboardManager) getContext().getSystemService(Context.CLIPBOARD_SERVICE);
                            ...
                            // for open game
                            playNow.setOnClickListener(view -> openApplication(getActivity(), packagename));
                        }
    ...
    public void JSON_PARSE_DATA_AFTER_WEBCALL_JOIN(JSONArray array) {
        ...
        for (int i = 0; i < array.length(); i++) {
            ...
            try {
                ...
                final TextView r_team = view.findViewById(R.id.registeredteam);
                final TextView r_position = view.findViewById(R.id.registeredposition);
                final TextView r_pubgname = view.findViewById(R.id.registeredpubgname);
                ...
                r_pubgname.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Button newcancel = builder.findViewById(R.id.newcancel);
                        ...
                        newok.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                final JsonObjectRequest jrequest = new JsonObjectRequest(jurl, new JSONObject(params),
                                        ...
                                        }, error -> Log.e("error " + String.valueOf(error.getNetworkTimeMs()), String.valueOf(error))) {
                                    @Override
                                    protected Map<String, String> getParams() throws
                                            AuthFailureError {
                                        return super.getParams();
                        ...
                        newcancel.setOnClickListener(view1 -> builder.dismiss());
                        builder.show();
                    }
                });
