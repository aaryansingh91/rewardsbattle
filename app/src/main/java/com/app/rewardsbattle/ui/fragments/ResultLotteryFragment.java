...
import com.app.rewardsbattle.ui.adapters.LotteryResultAdapter;
...
public class ResultLotteryFragment extends Fragment {
    ...
    public View onCreateView( LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        pullToRefresh = root.findViewById(R.id.pullToRefreshinresultlottery);
        ...
        loadingDialog.show();
        noResult= root.findViewById(R.id.noresultlottery);
        recyclerView = root.findViewById(R.id.rvinresultlottery);
